...
def footer():
    ...
    st.markdown("[LinkedIn](https://www.linkedin.com/in/vyshali-nune-589b8b2b0/)")
    st.markdown("[GitHub](https://github.com/VYSHALI-NUNE)")
    st.markdown("📧 Email: vyshalinune2004@gmail.com")
